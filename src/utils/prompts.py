...
In order to add a new method, you can do the following things, and your response should be in JSON format(without extra characters lick "```" or "```json") with a key "opeartion":
...
Ensure your code is well-structured and follows software design principles, with no code smells
...
You can do the following things, and your response should be in JSON format(without extra characters lick "```" or "```json") with a key "opeartion":

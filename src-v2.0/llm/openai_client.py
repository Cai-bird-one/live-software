...
class OpenAIClient(BaseLLMClient):
    ...
    def chat(
        ...
        effective_temp = (
            openai.NOT_GIVEN if ("o3" in model_parameters.model or "o4-mini" in model_parameters.model)
            else (temperature if temperature is not None else model_parameters.temperature)
        )
